...
public:
   ...
   */
  bool check_timestep(int dt, bool verbose = false);
   ...
   */
  BBPrune::Reason check_stability(Project &p, bool verbose = false);
   ...
   */
  BBPrune::Reason check_feasibility(Project &p, int dt, const int h, double &cost, bool verbose);
